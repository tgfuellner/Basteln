...
CutterCylinderR=12.5;
CutterCylinderZ=21;

RollerCylinderR=CutterCylinderR;
RollerCylinderZ=CutterCylinderZ-1;
RollerCylinderZGuide=28;
RollerCylinderRGuide=2.5;

NotchWidth=RollerCylinderRGuide*2+0.5;
NotchLen1=10;
NotchLen2=10;
...
roundedBox([BaseX,BaseY,BaseZ], 5, true);
